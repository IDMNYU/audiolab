...
<img src = "./img/serge_patched.jpg" width="100%" title="Serge Modular System in use" alt="Serge Modular System in use">
...
<img src = "./img/sergebs_1_3.png" width="12%" title="Pulse Divider" alt="Pulse Divider">
...
Many commercial - standalone and Eurorack, pre-built and DIY (e.g. [here](https://afterlateraudio.com/products/benjolin-v2), [here](https://www.modulargrid.net/e/epoch-modular-benjolin), and [here](https://synthplex.com/store/index.php?route=product/product&product_id=66)) - versions of the Benjolin exist, some with added features or modifications. The Benjolin in the IDM Audio Lab is a double unit (two matched Benjolin circuits) with a mixer and [Accutronics reverb](http://www.accutronicsreverb.com/main/?skin=sub01_05_1.html) in a Serge format, built by [Grant Wilkinson](https://www.instagram.com/muncky/). The output of the Benjolin is fed to channel 7 on the mixer in the studio.
